...
1. Схема на реактор(на ваше усмотрение)   
...
5. Впрыскиватель реакторного хладагента  
...
На данных скриншотах показано как выглядит саркафаг с 8 реакторами
...
PS. Настоятельно не советую устанавливать какой-нибудь из компонентов на границе любого из чанков!
